...
<div class="page-breadcrumb">
 ...
 <div class="card-body bg-light">
                                   ...
                                   <div class="form-group row p-b-15">
                                        ...
                                        <div class="col-sm-9">     
                                        <asp:DropDownList ID="ddlCrop" runat="server" DataSourceID="SdsCropType" 
                                                                DataTextField="CropTypeName"  class="form-control" DataValueField="CropTypeID">
                                                            </asp:DropDownList>
                                   ...
                                   <div class="form-group row p-b-15">
                                        <label for="inputEmail3" class="col-sm-3 text-right control-label col-form-label">Time Duration: </label>
                                        <div class="col-sm-9">                                          
                                            <asp:TextBox class="form-control" id="Txttimeduration" runat="server">
                                            </asp:TextBox>
                                        </div>
                                    </div>
                                   
                                   <div class="form-group row p-b-15">
                                        <label for="inputEmail3" class="col-sm-3 text-right control-label col-form-label">Date Of Booking: </label>
                                        <div class="col-sm-9">                                          
                                            <asp:TextBox class="form-control" id="txtdateofbooking" runat="server">
                                            </asp:TextBox>
                                             <cc1:CalendarExtender ID="txtCalendar" runat="server" 
            Enabled="True" TargetControlID="txtdateofbooking">
        </cc1:CalendarExtender>
                                        </div>
                                    </div>
                                     <div class="form-group row p-b-15">
                                        <label for="inputEmail3" class="col-sm-3 text-right control-label col-form-label">Date Of Return: </label>
                                        <div class="col-sm-9">                                          
